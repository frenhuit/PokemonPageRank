...
public class UnitMultiplication {
    /**
     * Counts urls in 'from' url page, calculates weight of each url in it.
     * Assume there are n urls, then each url will get 1/n unit of weight.
     */
    ...
    /**
     * Gets origin weight of each 'from' url.
     */
    ...
    /**
     * For each 'to' url, calculate the amount of weight that a url will get.
     * Each 'to' url will get (weight of 'from' url) * (unit which is calculated in TransitionMapper)
     */
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        Job job = Job.getInstance(conf, "unit multiplication");
